        ...
        <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl flex flex-col overflow-hidden">
          ...
          >
            <div className="space-y-3 mb-6">
              ...
              <p className="text-sm font-medium text-slate-800 border-l-2 border-indigo-500 pl-3">
          ...
          <div className="border-t border-slate-200 bg-slate-50 px-6 py-5 space-y-4">
            <label
              className={`flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition-colors ${termsAccepted
